...
foreign key points commercial -> open (ADR-0005), so the open tables exist
...
Usage:
    ...
    python scripts/migrate.py --scope open     # Open root only (open-core deployment)
...
# Applied in this order; open before commercial (FK direction invariant, ADR-0005).
MIGRATION_ROOTS = (
...
def main():
    ...
    parser.add_argument(
        ...
        "Use 'open' for an open-core (precis-mcp) deployment.",
    )
