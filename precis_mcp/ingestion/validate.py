...
User-supplied check SQL — assertions over the staging rows like 'no
negative amounts on revenue accounts' — is a separate future
enhancement and lives elsewhere when it lands. This module is
