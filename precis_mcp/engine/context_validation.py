...
def _resolve_metric_domain(
    ...
    # (process_tool_call._normalise_list_of_str) catches this for tool
    # calls, but other entry paths exist (report_context, tests, future
    # callers). Returning None here matches the "unknown metric" contract
    # and avoids the unhashable-dict crash that motivated ISS-016.
