...
ceremony.  See docs/telemetry_strategy.md for the why.
...
def init_observability(app: Any) -> None:
    ...
    Reads:
        ...
        OTEL_SERVICE_NAME             — default "precis-agent"
    ...
    # this, gen_ai.* attributes use the deprecated names.  See
    # docs/telemetry_strategy.md §1.
    ...
    try:
        ...
        logger.info(
            ...
            os.getenv("OTEL_SERVICE_NAME", "precis-agent"),
        )
    except Exception:
...
def _init_tracer_provider() -> None:
    ...
    service_name = os.getenv("OTEL_SERVICE_NAME", "precis-agent")
...
def _init_instrumentors(app: Any) -> None:
    ...
    # the open package since the ADR-0006 lock move).
