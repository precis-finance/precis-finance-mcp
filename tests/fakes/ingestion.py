...
class FakeLoadHistoryWriter:
    ...
    def record_checks(self, load_id, control_total_result) -> None:
        self.rows[load_id]["control_total_result"] = control_total_result
        self.events.append(f"checks:{load_id}")
